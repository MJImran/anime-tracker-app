  ...
  return (
    isModal && (
      <div className="p-2 fixed top-0 right-0 left-0 bottom-0 bg-slate-300/70 flex justify-center backdrop-blur-md ">
        <section
          className={`mt-15 mb-20 rounded-sm flex flex-col gap-6 h-${height} mx-auto w-full shadow-lg p-3 items-center relative`}
        >
          <button
            onClick={() => {
            ...
            className="absolute -top-12 right-0 font-bold  h-10 w-10 text-slate-600 text-3xl cursor-pointer "
          >
            <IoMdClose />
          </button>
